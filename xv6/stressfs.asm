  ...
  1c:	31 db                	xor    %ebx,%ebx
{
  ...
  5b:	83 c4 10             	add    $0x10,%esp
    if(fork() > 0)
  5e:	e8 37 03 00 00       	call   39a <fork>
  ...
  a2:	50                   	push   %eax
  a3:	e8 42 03 00 00       	call   3ea <open>
...
//    printf(fd, "%d\n", i);
  ...
  b8:	56                   	push   %esi
  b9:	57                   	push   %edi
  ba:	e8 0b 03 00 00       	call   3ca <write>
  for(i = 0; i < 20; i++)
  ...
  ca:	57                   	push   %edi
  cb:	e8 02 03 00 00       	call   3d2 <close>
  ...
  ee:	e8 f7 02 00 00       	call   3ea <open>
 ...
 108:	56                   	push   %esi
 109:	57                   	push   %edi
 10a:	e8 b3 02 00 00       	call   3c2 <read>
  for (i = 0; i < 20; i++)
 ...
 11a:	57                   	push   %edi
 11b:	e8 b2 02 00 00       	call   3d2 <close>

  wait(0x0);
 120:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 127:	e8 7e 02 00 00       	call   3aa <wait>

  exit(0);
 12c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 133:	e8 6a 02 00 00       	call   3a2 <exit>
}
 ...
 469:	85 d2                	test   %edx,%edx
{
 ...
 4d0:	e8 f5 fe ff ff       	call   3ca <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 540:	e8 85 fe ff ff       	call   3ca <write>
 ...
 5b8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 5ba:	e8 0b fe ff ff       	call   3ca <write>
  for(i = 0; fmt[i]; i++){
 ...
 653:	57                   	push   %edi
 654:	53                   	push   %ebx
 655:	e8 70 fd ff ff       	call   3ca <write>
        while(*s != 0){
 ...
 6a7:	e8 1e fd ff ff       	call   3ca <write>
        ap++;
 ...
 6d1:	a1 4c 0b 00 00       	mov    0xb4c,%eax
{
 ...
 70d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 70f:	a3 4c 0b 00 00       	mov    %eax,0xb4c
}
 714:	5b                   	pop    %ebx
 715:	5e                   	pop    %esi
 716:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 769:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 76c:	8b 15 4c 0b 00 00    	mov    0xb4c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7d6:	e8 f5 fe ff ff       	call   6d0 <free>
  return freep;
 7db:	8b 15 4c 0b 00 00    	mov    0xb4c,%edx
 ...
 804:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 807:	89 15 4c 0b 00 00    	mov    %edx,0xb4c
}
 ...
 819:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 820:	c7 05 4c 0b 00 00 50 	movl   $0xb50,0xb4c
 827:	0b 00 00 
 82a:	c7 05 50 0b 00 00 50 	movl   $0xb50,0xb50
 831:	0b 00 00 
    base.s.size = 0;
 834:	b8 50 0b 00 00       	mov    $0xb50,%eax
 839:	c7 05 54 0b 00 00 00 	movl   $0x0,0xb54
 840:	00 00 00 
