...
main(int argc, char **argv)
{
  ...
  38:	e8 cd 02 00 00       	call   30a <kill>
  for(i=1; i<argc; i++)
  ...
  47:	6a 00                	push   $0x0
  49:	e8 84 02 00 00       	call   2d2 <exit>
}
  4e:	8d 65 f4             	lea    -0xc(%ebp),%esp
 ...
 601:	a1 64 0a 00 00       	mov    0xa64,%eax
{
 ...
 63d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 63f:	a3 64 0a 00 00       	mov    %eax,0xa64
}
 644:	5b                   	pop    %ebx
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 757:	0a 00 00 
 75a:	c7 05 68 0a 00 00 68 	movl   $0xa68,0xa68
 761:	0a 00 00 
    base.s.size = 0;
 764:	b8 68 0a 00 00       	mov    $0xa68,%eax
 769:	c7 05 6c 0a 00 00 00 	movl   $0x0,0xa6c
 770:	00 00 00 
