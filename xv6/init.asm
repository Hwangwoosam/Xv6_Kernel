...
main(void)
{
  ...
  19:	e8 7c 03 00 00       	call   39a <open>
  ...
  28:	6a 01                	push   $0x1
  2a:	6a 01                	push   $0x1
  2c:	68 08 08 00 00       	push   $0x808
  31:	e8 6c 03 00 00       	call   3a2 <mknod>
    open("console", O_RDWR);
  36:	59                   	pop    %ecx
  37:	5b                   	pop    %ebx
  38:	6a 02                	push   $0x2
  3a:	68 08 08 00 00       	push   $0x808
  3f:	e8 56 03 00 00       	call   39a <open>
  44:	83 c4 10             	add    $0x10,%esp
  }
  dup(0);  // stdout
  47:	83 ec 0c             	sub    $0xc,%esp
  4a:	6a 00                	push   $0x0
  4c:	e8 81 03 00 00       	call   3d2 <dup>
  dup(0);  // stderr
  51:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  58:	e8 75 03 00 00       	call   3d2 <dup>
  5d:	83 c4 10             	add    $0x10,%esp

  for(;;){
    printf(1, "init: starting sh\n");
  60:	83 ec 08             	sub    $0x8,%esp
  63:	68 10 08 00 00       	push   $0x810
  68:	6a 01                	push   $0x1
  ...
  83:	6a 00                	push   $0x0
  85:	e8 d0 02 00 00       	call   35a <wait>
  ...
  b3:	68 08 0b 00 00       	push   $0xb08
  b8:	68 36 08 00 00       	push   $0x836
  bd:	e8 d0 02 00 00       	call   392 <exec>
      printf(1, "init: exec sh failed\n");
  c2:	58                   	pop    %eax
  c3:	5a                   	pop    %edx
  c4:	68 39 08 00 00       	push   $0x839
  c9:	6a 01                	push   $0x1
  cb:	e8 e0 03 00 00       	call   4b0 <printf>
      exit(0);
  d0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  d7:	e8 76 02 00 00       	call   352 <exit>
  dc:	83 c4 10             	add    $0x10,%esp
  df:	eb 9f                	jmp    80 <main+0x80>
  e1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      printf(1, "init: fork failed\n");
  e8:	83 ec 08             	sub    $0x8,%esp
  eb:	68 23 08 00 00       	push   $0x823
  f0:	eb d7                	jmp    c9 <main+0xc9>
  f2:	66 90                	xchg   %ax,%ax
  f4:	66 90                	xchg   %ax,%ax
  f6:	66 90                	xchg   %ax,%ax
  f8:	66 90                	xchg   %ax,%ax
