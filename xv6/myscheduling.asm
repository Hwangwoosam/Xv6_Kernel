...
_myscheduling:     file format elf32-i386
  ...
  47:	83 c4 10             	add    $0x10,%esp
{
  4a:	31 db                	xor    %ebx,%ebx
	...
	for(int i = 0; i < npid; i++) {
		pid[i] = fork() ;
  4c:	e8 59 03 00 00       	call   3aa <fork>
		if (pid[i] < 0) {
  51:	85 c0                	test   %eax,%eax
		pid[i] = fork() ;
  53:	89 44 9d d4          	mov    %eax,-0x2c(%ebp,%ebx,4)
		if (pid[i] < 0) {
  57:	78 1c                	js     75 <main+0x75>
			printf(1, "pid[%d] fork error.\n", i) ;
			exit(1) ;
		} else if (pid[i] == 0) {
  59:	75 39                	jne    94 <main+0x94>
			setpriority(getpid(), i) ;
  5b:	e8 da 03 00 00       	call   43a <getpid>
  ...
  65:	83 c3 01             	add    $0x1,%ebx
			setpriority(getpid(), i) ;
  68:	e8 ed 03 00 00       	call   45a <setpriority>
			child_func(i+1) ;	
  6d:	89 1c 24             	mov    %ebx,(%esp)
  70:	e8 9b 00 00 00       	call   110 <child_func>
			printf(1, "pid[%d] fork error.\n", i) ;
  75:	83 ec 04             	sub    $0x4,%esp
  78:	53                   	push   %ebx
  79:	68 8a 08 00 00       	push   $0x88a
  7e:	6a 01                	push   $0x1
  80:	e8 8b 04 00 00       	call   510 <printf>
			exit(1) ;
  85:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8c:	e8 21 03 00 00       	call   3b2 <exit>
  91:	83 c4 10             	add    $0x10,%esp
	for(int i = 0; i < npid; i++) {
  94:	83 c3 01             	add    $0x1,%ebx
  97:	83 fb 05             	cmp    $0x5,%ebx
  9a:	75 b0                	jne    4c <main+0x4c>
  9c:	8d 75 d0             	lea    -0x30(%ebp),%esi
  9f:	90                   	nop
			continue ;
		}
	}
  ...
  a2:	8b 7c 9d d4          	mov    -0x2c(%ebp,%ebx,4),%edi
  a6:	83 ec 08             	sub    $0x8,%esp
  a9:	56                   	push   %esi
  aa:	57                   	push   %edi
  ab:	e8 b2 03 00 00       	call   462 <getpriority>
  b0:	83 c4 10             	add    $0x10,%esp
  b3:	85 c0                	test   %eax,%eax
  b5:	74 21                	je     d8 <main+0xd8>
		for (int i = 0; i < npid; i++) {
  b7:	83 c3 01             	add    $0x1,%ebx
  ba:	83 fb 05             	cmp    $0x5,%ebx
  bd:	75 e3                	jne    a2 <main+0xa2>
				setpriority(pid[i], (prio+1)%npid) ;
		}
		sleep(500) ;
  bf:	83 ec 0c             	sub    $0xc,%esp
  c2:	68 f4 01 00 00       	push   $0x1f4
  c7:	e8 7e 03 00 00       	call   44a <sleep>
		for (int i = 0; i < npid; i++) {
  cc:	83 c4 10             	add    $0x10,%esp
  cf:	eb cf                	jmp    a0 <main+0xa0>
  d1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
				setpriority(pid[i], (prio+1)%npid) ;
  d8:	8b 45 d0             	mov    -0x30(%ebp),%eax
  db:	83 ec 08             	sub    $0x8,%esp
  de:	8d 48 01             	lea    0x1(%eax),%ecx
  e1:	b8 67 66 66 66       	mov    $0x66666667,%eax
  e6:	f7 e9                	imul   %ecx
  e8:	89 c8                	mov    %ecx,%eax
  ea:	c1 f8 1f             	sar    $0x1f,%eax
  ed:	d1 fa                	sar    %edx
  ef:	29 c2                	sub    %eax,%edx
  f1:	8d 04 92             	lea    (%edx,%edx,4),%eax
  f4:	29 c1                	sub    %eax,%ecx
  f6:	51                   	push   %ecx
  f7:	57                   	push   %edi
  f8:	e8 5d 03 00 00       	call   45a <setpriority>
  fd:	83 c4 10             	add    $0x10,%esp
 100:	eb b5                	jmp    b7 <main+0xb7>
...
00000110 <child_func>:
{
 ...
 119:	8b 75 08             	mov    0x8(%ebp),%esi
	int pid = getpid() ;
 11c:	e8 19 03 00 00       	call   43a <getpid>
 121:	89 c7                	mov    %eax,%edi
 123:	90                   	nop
 124:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
		for (int i = 0; i < n; i++) {
 128:	85 f6                	test   %esi,%esi
 12a:	7e 1d                	jle    149 <child_func+0x39>
 ...
 133:	83 c3 01             	add    $0x1,%ebx
			printf(1, "  ") ;
 136:	68 68 08 00 00       	push   $0x868
 13b:	6a 01                	push   $0x1
 13d:	e8 ce 03 00 00       	call   510 <printf>
		for (int i = 0; i < n; i++) {
 142:	83 c4 10             	add    $0x10,%esp
 145:	39 de                	cmp    %ebx,%esi
 147:	75 e7                	jne    130 <child_func+0x20>
		printf(1, "%d\n", pid) ;
 149:	83 ec 04             	sub    $0x4,%esp
 14c:	57                   	push   %edi
 14d:	68 6b 08 00 00       	push   $0x86b
 152:	6a 01                	push   $0x1
 154:	e8 b7 03 00 00       	call   510 <printf>
		for (int i = 0; i < n; i++) {
 159:	83 c4 10             	add    $0x10,%esp
 15c:	eb ca                	jmp    128 <child_func+0x18>
...
printf(int fd, const char *fmt, ...)
{
 ...
 6c4:	e9 8f fe ff ff       	jmp    558 <printf+0x48>
          s = "(null)";
 6c9:	bb 9f 08 00 00       	mov    $0x89f,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e1:	a1 78 0b 00 00       	mov    0xb78,%eax
{
 ...
 71d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 71f:	a3 78 0b 00 00       	mov    %eax,0xb78
}
 724:	5b                   	pop    %ebx
 725:	5e                   	pop    %esi
 726:	5f                   	pop    %edi
 ...
 736:	72 ce                	jb     706 <free+0x26>
{
 ...
 757:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 75a:	a3 78 0b 00 00       	mov    %eax,0xb78
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 15 78 0b 00 00    	mov    0xb78,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7bf:	73 47                	jae    808 <malloc+0x98>
    ...
    if(p == freep)
 7c1:	39 05 78 0b 00 00    	cmp    %eax,0xb78
 ...
 7e6:	e8 f5 fe ff ff       	call   6e0 <free>
  return freep;
 7eb:	8b 15 78 0b 00 00    	mov    0xb78,%edx
 ...
 814:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 817:	89 15 78 0b 00 00    	mov    %edx,0xb78
}
 ...
 829:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 830:	c7 05 78 0b 00 00 7c 	movl   $0xb7c,0xb78
 837:	0b 00 00 
 83a:	c7 05 7c 0b 00 00 7c 	movl   $0xb7c,0xb7c
 841:	0b 00 00 
    base.s.size = 0;
 844:	b8 7c 0b 00 00       	mov    $0xb7c,%eax
 849:	c7 05 80 0b 00 00 00 	movl   $0x0,0xb80
 850:	00 00 00 
