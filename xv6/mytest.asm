...
int main(){
 ...
 printf(1,"%p address\n",&i);
  1b:	50                   	push   %eax
  1c:	68 48 07 00 00       	push   $0x748
  21:	6a 01                	push   $0x1
  23:	e8 c8 03 00 00       	call   3f0 <printf>
 exit(0);
 ...
 5c1:	a1 08 0a 00 00       	mov    0xa08,%eax
{
 ...
 5fd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5ff:	a3 08 0a 00 00       	mov    %eax,0xa08
}
 604:	5b                   	pop    %ebx
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6f4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6f7:	89 15 08 0a 00 00    	mov    %edx,0xa08
}
 ...
 709:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 08 0a 00 00 0c 	movl   $0xa0c,0xa08
 717:	0a 00 00 
 71a:	c7 05 0c 0a 00 00 0c 	movl   $0xa0c,0xa0c
 721:	0a 00 00 
    base.s.size = 0;
 724:	b8 0c 0a 00 00       	mov    $0xa0c,%eax
 729:	c7 05 10 0a 00 00 00 	movl   $0x0,0xa10
 730:	00 00 00 
